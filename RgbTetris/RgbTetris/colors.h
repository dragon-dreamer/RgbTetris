...
public:
	...
	*   @returns RGB color */
	static color::rgb get_random_color(uint8_t min_component_value, uint8_t max_component_value);
	
	///Converts color components to RGB color
	static constexpr uint32_t make_rgb(uint8_t r, uint8_t g, uint8_t b)
	{
	...
	static constexpr color::rgb from_rgb(color_code code)
	{
	...
	///Scales color component to specified brightness value
	static constexpr uint8_t scale_to_brightness(uint8_t color, uint8_t brightness)
	{
